...
const AboutMe = () => {
    ...
    return (
        <Section id={"aboutMe"} title={"Sobre Mim"}>
            <SectionText>
                Tenho 21 anos, técnico em informática pela escola profissionalizante EEEP Jaime Alencar de Oliveira e atualmente estou no quarto semestre de 
                Análise e Desenvolvimento de Sistemas na Universidade de Fortaleza. Sou apaixonado por tecnologia desde a infância e, por isso, durante e após a escola, 
                busquei me especializar em programação.
                <br/>
                Desenvolvedor Full Stack com mais de 3 anos de experiência no mercado, experiente em React e React Native para Front-end e com conhecimento em Node.js e Django 
